...
interface IAnswersProps {
  ...
  playAudioCorrect: Function,
  playAudioFailure: Function
}
...
export function Answers(props: IAnswersProps): JSX.Element {
  ...
  const renderAnswers = (): JSX.Element[] => {
    return props.birds.map((bird, index) => <AnswerListItem key={bird.id} isCorrectClass={isCorrectAnswers[index]}  id={bird.id} pickAnswer={pickAnswer} name={bird.name} />)
  }
